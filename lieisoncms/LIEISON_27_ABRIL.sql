...
INSERT INTO `sales_entradas` VALUES (22,8,'esanchez30admin10528679','2015-04-19','22:18:54'),(21,19,'esanchez30admin10528679','2015-04-21','11:25:28'),(20,19,'geabenitez51admin11122516','2015-04-20','12:17:14'),(19,18,'rolando55admin18894933','2015-04-23','16:33:15'),(29,22,'geabenitez51admin11122516','2015-04-25','02:28:33'),(18,19,'rolando55admin18894933','2015-04-24','10:38:06'),(16,13,'rolando55admin18894933','2015-04-21','10:57:10'),(23,2,'rolando55admin18894933','2015-04-23','16:57:06'),(24,2,'esanchez30admin10528679','2015-04-21','00:26:10'),(25,8,'rolando55admin18894933','2015-04-23','16:54:53'),(26,2,'geabenitez51admin11122516','2015-04-24','01:27:47'),(27,21,'geabenitez51admin11122516','2015-04-24','01:30:42'),(28,21,'rolando55admin18894933','2015-04-23','19:53:30'),(30,22,'rolando55admin18894933','2015-04-25','00:32:54');
...
INSERT INTO `seccion_dashboard` VALUES (1,1,'icon-home','Dashboard','0',1),(2,2,'fa fa-cog','Front-End','55',0),(3,3,'fa fa-user','Usuarios','55',1),(4,2,'fa fa-line-chart','Sales','76',1),(5,4,'fa fa-unlock-alt','Configuracion','55,155',1),(8,2,'fa fa-tasks','Task','55,76',1),(9,5,'fa fa-exchange','Seccion Prueba','55',1);
...
INSERT INTO `visitas` VALUES (2,223,2,2015),(3,50,3,2015),(4,110,1,2015),(5,1,4,2015);
...
/*!50001 VIEW `view_dashboard_db` AS select `lieison_soft`.`dashboard`.`id_dashboard` AS `id`,`lieison_soft`.`dashboard`.`titulo` AS `dash_titulo`,`lieison_soft`.`seccion_dashboard`.`titulo` AS `sec_titulo`,`lieison_soft`.`dashboard`.`link` AS `link`,`lieison_soft`.`dashboard`.`icono` AS `icono`,`lieison_soft`.`dashboard`.`privilegios` AS `priv_nombre`,`lieison_soft`.`dashboard`.`status` AS `status` from ((`dashboard` join `seccion_dashboard` on((`lieison_soft`.`dashboard`.`id_seccion` = `lieison_soft`.`seccion_dashboard`.`id_seccion`))) join `privilegios` on((`lieison_soft`.`dashboard`.`privilegios` = `lieison_soft`.`privilegios`.`nivel`))) where (`lieison_soft`.`dashboard`.`link` like '%dashboard%') */;
...
-- Dump completed on 2015-04-26 15:15:29
